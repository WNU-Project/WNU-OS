...
int boot_sequence() {
    ...
    printf("\n");
    printf("Welcome To WNU OS 1.0.2 (Windows Bash Shell)!\n");
    ...
    printf("WNU OS 1.0.2 boot completed successfully.\n");
